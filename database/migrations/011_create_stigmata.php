...
return [
    'version'     => '011',
    'description' => 'Create stigmata, stigma_effects and stigma_levelup_conditions tables',
    'up'          => [
        "CREATE TABLE IF NOT EXISTS `stigmata` (
        ...
        "CREATE TABLE IF NOT EXISTS `stigma_effects` (
            `id`           int          NOT NULL AUTO_INCREMENT,
            `stigma_uuid`  varchar(64)  COLLATE utf8mb3_bin NOT NULL,
            `nom`          varchar(256) COLLATE utf8mb3_bin NOT NULL DEFAULT '',
            `type`         varchar(32)  COLLATE utf8mb3_bin NOT NULL DEFAULT 'passif',
            `valeur`       varchar(512) COLLATE utf8mb3_bin DEFAULT NULL,
            `description`  text         COLLATE utf8mb3_bin DEFAULT NULL,
            `ordre`        int          NOT NULL DEFAULT 0,
            PRIMARY KEY (`id`)
        ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_bin;",

        "CREATE TABLE IF NOT EXISTS `stigma_levelup_conditions` (
            `id`           int          NOT NULL AUTO_INCREMENT,
            `stigma_uuid`  varchar(64)  COLLATE utf8mb3_bin NOT NULL,
    ...
    'down' => [
        "DROP TABLE IF EXISTS `stigma_levelup_conditions`;",
        "DROP TABLE IF EXISTS `stigma_effects`;",
        "DROP TABLE IF EXISTS `stigmata`;",
    ],
];
