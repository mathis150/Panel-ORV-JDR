    ...
    <div class="orv-menu_container">
        <div class="orv-menu_form">
            <div>
                ...
                <cite>Toutes les informations importantes pour le compte. (Le mot de passe sera envoyé automatiquement à l'utilisateur, avec son e-mail.)</cite>
            </div>
            <div class="orv-menu_form-elements">
                <div class="orv-menu_form-inputs-list">
                    ...
                    <div class="orv-menu_form-input">
                        ...
                        <select>
                            <option value="sudo">Super-Administrateur</option>
