    ...
    <div class="orv-menu_container">
        <div class="orv-menu_form">
            <div>
                ...
                <br>
                <h4 class="classic-title">Vous vous apprétez à supprimer un utilisateur !</h4>
                <br>
                <cite style="font-size: 16px;">Cette action est irréversible et tout les éléments propre à l'utilisateur seront PERDU à jamais !<br>Vous ne pourrez pas les récupérer ou les sauver !</cite>
            </div>
        </div>
    </div>
</div>